  ...
  <body id="page-top">
   ...
   <c:import url="/include/base_nav.jsp"></c:import>
    ...
    <div class="container-fluid">
      <h1 class="h5 text-gray-800">RESIDENT</h1>
      <!-- DataTales Example -->
      <!-- Log on to codeastro.com for more projects -->
          ...
          <div class="table-responsive">
            ...
            <c:forEach items="${listProp.rows}" var="mapProp" varStatus="boucle">
                <tr>
                  ...
                  <td>${mapProp.tel}</td>
                  <td>${mapProp.zone}</td>                                                
                  <td align="center"><a onclick="document.location.href='<c:url value="/view_RESIDENT?id=${mapProp.id}&page=${page}&crud=id" />'"><img alt=""  style=" width: 25px;" src="assets/frontend/img/mod.jpg"></a> 
                  
                   <button onclick="document.location.href='<c:url value="/RESIDENT?id=${mapProp.id}&page=${page}&crud=id" />'"><img alt=""  style=" width: 25px;" src="assets/frontend/img/supp.jpg"></button>
...
<div class="modal-content" style="width:810px;margin-left:-35px;">
  <div class="modal-header">
    <h5 class="modal-title text-success" id="exampleModalLabel"> AJOUTER UN RESIDENT </h5>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    <span aria-hidden="true">&times;</span>
    </button>
  </div>
  <div class="modal-body">
    <form action="<c:url value="/resident"/>" method="post"  class="myFormulaire">
      ...
      <div class="form-group row">   
        <div class="col-sm-4 mb-2 mb-sm-0">
           <label for="seat" class="">DATE D'AJOUT</label>
            <input type="date" name="prenom" class="form-control" required  value="">
           </div> 
      </div> 
