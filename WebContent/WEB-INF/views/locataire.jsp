...
<sql:query var="listProp" dataSource="jdbc/gestions_imm">
	select * from locataire where code="${sessionScope.agence.code}" and type="physique" AND archive="0"
</sql:query>
...
<head>
  ...
  <meta name="author" content="">
		...
		<!-- Site Title -->
		<title>GESTIONS DES LOCATAIRES PHYSIQUES</title>
  ...
  <body id="page-top">
   ...
   <c:import url="/include/base_nav.jsp"></c:import>
    ...
    <div class="container-fluid">
      <h1 class="h5 text-gray-800">GESTIONS DES LOCATAIRES-PHYSIQUES</h1>
      <!-- DataTales Example -->
      <!-- Log on to codeastro.com for more projects -->
            ...
            <thead class="thead-dark">
             ...
             <c:forEach items="${listProp.rows}" var="mapProp" varStatus="boucle">
                <tr>
                  ...
                  <td align="center"><a onclick="document.location.href='<c:url value="/view_locataire?id=${mapProp.id}&page=${page}&crud=id" />'"><img alt=""  style=" width: 25px;" src="assets/frontend/img/mod.jpg"></a> 
                  <c:if test="${sessionScope.rolePr.supp_LO==1}">
                   <button onclick="document.location.href='<c:url value="/locataire?id=${mapProp.id}&matri=${mapProp.matricule}&page=${page}&crud=id" />'"><img alt=""  style=" width: 25px;" src="assets/frontend/img/supp.jpg"></button>
                  </c:if> 
                  </td>
...
<div class="modal-content" style="width:910px;margin-left:-35px;">
  <div class="modal-header">
    <h5 class="modal-title text-success" id="exampleModalLabel"> AJOUTER UN LOCATAIRE-PHYSIQUE</h5>
  ...
  <div class="modal-body">
    <form id="myFormL"  class="myFormulaire">
      ...
      <div class="form-group row">
        <div class="col-sm-4 mb-2 mb-sm-0">
        <label for="date_naiss" class="">DATE DE NAISSANCE<span class="text-danger ml-2">*</span></label>
         <input type="date" required  name="date_naiss" id="date_naiss" class="form-control" value="">
        </div>
       <div class="col-sm-4 mb-2 mb-sm-0">
        <label for="platbus" class="">LIEU DE NAISSANCE</label>
        <input type="text" name="lieu_naiss" id="lieu_naiss" class="form-control" value="">
        </div>
         <div class="col-sm-4 mb-2 mb-sm-0">
      ...
      <div class="form-group row">  
	   ...
	   <input type="text" name="fonction" id="fonction" class="form-control" value="">
       </div>
       <div class="col-sm-4 mb-2 mb-sm-0">
...
<div class="suppPop" id="supp">
		<div class="mesSuppN">
			...
			<form action="<c:url value="/view_maison"/>" method="post" class="btnSupp" style='margin-top:-10px;'>				
				...
				<button class="btn btn-danger" name="crud" value="MODIFIERM">ok</button>
