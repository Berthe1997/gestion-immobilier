...
<head>
  ...
  <meta name="author" content="">
		...
		<!-- Site Title -->
		<title> GESTIONS DES LOCATAIRES MORAL</title>
     ...
     <!-----------------------------------------------FIN DE L'ENTÊTE------------------------------------------  -->
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary" style="text-align:center;">MODIFIER LOCATAIRE-MORAL   </h6>
        </div>
        <div class="card-body">
        ...
        <hr><a class="btn btn-danger float-left" href="<c:url value="/menus?menu=locataire"/>"> Retour</a>
           ...
           <c:if test="${sessionScope.rolePr.modif_LO==1}">
             <button name="crud" value="MODIFIER" type="submit" class="btn btn-success">Modifier</button>
                  ...
                  <a  class="btn btn btn-info float-right" href="#etat_6" data-toggle="modal">Rapport Locataire</a>                                                   
                  </c:if>
           </form>  
            </div>
          </div>
                        ...
                        <div class="modal-body">                                             
                            <form action="<c:url value="/view_locataire"/>" id="formAdd"  method="post"  class="myFormulaire" enctype="multipart/form-data">
				               <div class="form-group row">        
						        ...
						        <div class="col-sm-4 mb-2 mb-sm-0">
						         <label for="platbus" class="">CONTACT </label>
							     <input type="text" name="prenomC" class="form-control" value="<c:out value="${locataire.tel}"/>" disabled>
						       </div>						            		
								<div class="col-sm-4 mb-2 mb-sm-0">
						       ...
						       <div class="modal-footer">	
						        ...
						        <button name="crud" value="AJOUTERM" class="btn btn-success">Sauvegarder</button>
						      </div>
                            </form>
								 ...
								 <c:forEach items="${listDoc.rows}" var="mapDoc" varStatus="boucle">
									<div class="tr ${boucle.index % 2 == 0 ? 'pair' : 'impair'}">
										...
										<div class="td tdCenter" style="width:10%;">
										 ...
										 <button onclick="document.location.href='<c:url value="/view_locataire?id=${mapDoc.id}&matri=${mapDoc.client}&page=${page}&crud=idsM" />'"><img alt=""  style=" width: 25px;" src="assets/frontend/img/supp.jpg"></button>
										</div>
									</div>
								</c:forEach>
							  </div>
