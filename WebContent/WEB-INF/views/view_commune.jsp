     ...
     <!-----------------------------------------------FIN DE L'ENTÊTE------------------------------------------  -->
      ...
      <div class="card shadow mb-4" style="width:600px;margin-left:200px;">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary" style="text-align:center;">MODIFIER COMMUNE   </h6>
        </div>
        <div class="card-body">
          <form action="<c:url value="/view_commune"/>" method="post"  class="myFormulaire">
      ...
      <input type="hidden" name="id" value="<c:out value="${commune.id}"/>">
        <hr><a class="btn btn-danger float-left" href="<c:url value="/menus?menu=commune"/>"> Retour</a>
             &nbsp;&nbsp;
