  ...
  <body id="page-top" style="background-image: url('assetss/images/logos.jpeg');">
   ...
   <c:import url="/include/base_nav.jsp"></c:import>
    ...
    <div class="container-fluid" >
      <h1 class="h5 text-gray-800">GESTIONS AGENCE</h1>
      <!-- DataTales Example -->
      <!-- Log on to codeastro.com for more projects -->
            ...
            <sql:query var="listProp" dataSource="jdbc/gestions_imm">
			  ...
			  <c:forEach items="${listProp.rows}" var="mapProp" varStatus="boucle"> 
                <tr>
                  ...
                  <td>${mapProp.agence}</td>
                  <td>${mapProp.adresse}</td>
                  <td>${mapProp.tel}</td>
                  <td>${mapProp.email}</td>
                  <td>${mapProp.date_ajout}</td>
                  <td> ${mapProp.directeur}</td>                                   
                  <td align="center"><a  onclick="document.location.href='<c:url value="/view_agence?id=${mapProp.id}&page=${page}&crud=id" />'"><img alt=""  style=" width: 25px;" src="assets/frontend/img/mod.jpg"></a> 
                   <c:if test="${sessionScope.rolePr.supp_AG==1}">
                   <button onclick="document.location.href='<c:url value="/agence?id=${mapProp.id}&page=${page}&crud=id" />'"><img alt=""  style=" width: 25px;" src="assets/frontend/img/supp.jpg"></button>
                  </c:if>
                  </td>
...
<div class="modal-content" style="width:980px;margin-left:-55px;">
  <div class="modal-header">
    <h5 class="modal-title text-success" id="exampleModalLabel"> AJOUTER UNE AGENCE </h5>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    <span aria-hidden="true">&times;</span>
    </button>
  </div>
  <div class="modal-body">
    <form action="<c:url value="/agence"/>" method="post"  class="myFormulaire">
      ...
      <div class="form-group row">      
       ...
       <div class="col-sm-4 mb-2 mb-sm-0">
		...
		<input type="text" name="montant_L" class="form-control" value="">
       </div>
       <div class="col-sm-4 mb-2 mb-sm-0">
      ...
      <div class="form-group row">      
	   ...
	   <input type="text" name="registre_C" class="form-control" value="">
       </div>
      </div>
      <div class="form-group row">      
        <div class="col-sm-4 mb-2 mb-sm-0">
         <label for="platbus" class="">COMPTEUR CIE </label>
	     <input type="text" name="cei" class="form-control" value="">
       </div>
