...
@WebServlet("/droit_casM")
public class CrudDroit_casU_M extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		this.getServletContext().getRequestDispatcher(IMMOBILIER_M).forward(request, response);
