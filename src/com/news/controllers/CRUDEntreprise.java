...
public class CRUDEntreprise extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String INDEX 	= "/index.jsp";
	private static final String ENTREPRISE = "/WEB-INF/views/entreprise.jsp";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		return;
			...
			if(crud.equals("id")) {
				...
				entrepriseDI.supprimerEntreprise(entreprise, errorMsg);
			}
	...
	if(crud.equals("AJOUTER")) {
		if(entrepriseDI.getEntrepriseVerifie(entreprises) == false) {
			...
			if(entrepriseDI.creerEntreprise(entreprise, errorMsg)) {
				request.setAttribute("message", new Message("Entreprise enregistré avec succès."+ errorMsg.get(), 0, "green"));
			}else request.setAttribute("message", new Message("Echec enregistrement Entreprise. " + errorMsg.get(), 0, "red") );
		}else request.setAttribute("message", new Message("Cet Entreprise existe déjà. " + errorMsg.get(), 0, "red") );
		}
