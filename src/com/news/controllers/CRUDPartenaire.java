...
public class CRUDPartenaire extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String INDEX 	= "/index.jsp";
	private static final String PARTENAIRE = "/WEB-INF/views/partenaire.jsp";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		return;
			...
			if(crud.equals("id")) {
				...
				partenaireDI.supprimerPartenaire(partenaire, errorMsg);
			}
	...
	//	String id	=	request.getParameter("id");
		...
		return;
			...
			if(crud.equals("AJOUTER")) {
				if(partenaireDI.getPartenaireVerifie(matricule) == false) {
					...
					if(partenaireDI.creerPartenaire(partenaire, errorMsg)) {
						request.setAttribute("message", new Message("Partenaire enregistré avec succès."+ errorMsg.get(), 0, "green"));
					}else request.setAttribute("message", new Message("Echec enregistrement Partenaire. " + errorMsg.get(), 0, "red") );
				}else request.setAttribute("message", new Message("Cet Partenaire existe déjà. " + errorMsg.get(), 0, "red") );
				}
