...
@WebServlet("/serviceT")
public class CRUDService_technique extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String INDEX 	= "/index.jsp";
	private static final String SERVICET = "/WEB-INF/views/service_technique.jsp";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		return;
			...
			if(crud.equals("id")) {
				...
				service_techniqueDI.supprimerService_technique(service_technique, errorMsg);
			}
	...
	//	String id	=	request.getParameter("id");
		...
		return;
			...
			if(crud.equals("AJOUTER")) {
				...
				if(service_techniqueDI.creerService_technique(service_technique, errorMsg)) {			
					request.setAttribute("message", new Message("Service_technique enregistré avec succès."+ errorMsg.get(), 0, "green"));
				} else request.setAttribute("message", new Message("Echec enregistrement Service_technique. " + errorMsg.get(), 0, "red") );
			}
